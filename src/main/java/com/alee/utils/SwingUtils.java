...
public final class SwingUtils extends CoreSwingUtils
{
    ...
    {
        final Rectangle componentBounds = getBoundsOnScreen ( component );
        final int half = componentBounds.width * componentBounds.height / 2;
        ...
        for ( final GraphicsDevice device : SystemUtils.getGraphicsDevices () )
        {
            ...
            if ( intersection.width > 0 && intersection.height > 0 )
            {
                ...
                else if ( maxIntersectionSize < size )
                {
