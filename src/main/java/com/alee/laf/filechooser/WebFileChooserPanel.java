...
public class WebFileChooserPanel extends WebPanel
{
     ...
     */
    protected final AbstractFileFilter selectedFilter = new AbstractFileFilter ()
    {
        @Override
     ...
     * File selection mode.
     */
    protected FileSelectionMode fileSelectionMode = FileSelectionMode.filesOnly;
    ...
    protected List<File> getFilteredSelectedFiles ( final Collection<File> allFiles )
    {
        ...
        return FileUtils.filterFiles ( files, selectedFilter );
    }
